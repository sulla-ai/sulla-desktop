...
export class ToolRegistry { private static registrations = new Map<string, ToolRegistration>();
  ...
  private categoriesList = [
    'meta', 'memory', 'bridge', 'browser', 'calendar', 'docker', 'extensions', 'fs', 'github', 'integrations', 'kubectl', 'n8n', 'playwright', 'projects', 'skills', 'slack', 'workspace', 'redis', 'pg', 'rdctl', 'lima',
