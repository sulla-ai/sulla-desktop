...
export const nativeAiMlIntegrations: Record<string, Integration> = {
  huggingface: {
    ...
    category: 'AI & ML', icon: 'huggingface.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Hugging Face',
  },
  replicate: {
    ...
    category: 'AI & ML', icon: 'replicate.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Replicate',
  },
  stability_ai: {
    ...
    category: 'AI & ML', icon: 'stability_ai.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Stability AI',
  },
  elevenlabs: {
    ...
    category: 'AI & ML', icon: 'elevenlabs.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ElevenLabs',
  },
  pinecone: {
    ...
    category: 'AI & ML', icon: 'pinecone.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Pinecone',
  },
  weaviate: {
    ...
    category: 'AI & ML', icon: 'weaviate.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Weaviate',
  },
  cohere: {
    ...
    category: 'AI & ML', icon: 'cohere.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Cohere',
  },
  mistral: {
    ...
    category: 'AI & ML', icon: 'mistral.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Mistral AI',
  },
  deepgram: {
    ...
    category: 'AI & ML', icon: 'deepgram.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Deepgram',
  },
  assemblyai: {
    ...
    category: 'AI & ML', icon: 'assemblyai.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'AssemblyAI',
  },
  qdrant: {
    ...
    category: 'AI & ML', icon: 'qdrant.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Qdrant',
  },
  chromadb: {
    ...
    category: 'AI & ML', icon: 'chromadb.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Chroma',
  },
  langsmith: {
    ...
    category: 'AI & ML', icon: 'langsmith.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'LangChain',
  },
  together_ai: {
    ...
    category: 'AI & ML', icon: 'together_ai.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Together AI',
  },
  groq: {
    ...
    category: 'AI & ML', icon: 'groq.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Groq',
  },
  perplexity: {
    ...
    category: 'AI & ML', icon: 'perplexity.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Perplexity AI',
  },
};
