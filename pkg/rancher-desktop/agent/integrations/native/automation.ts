...
export const nativeAutomationIntegrations: Record<string, Integration> = {
  zapier: {
    ...
    category: 'Automation', icon: 'zapier.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Zapier',
  },
  make: {
    ...
    category: 'Automation', icon: 'make.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Make',
  },
  ifttt: {
    ...
    category: 'Automation', icon: 'ifttt.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'IFTTT',
  },
  webhooks: {
    ...
    category: 'Automation', icon: 'webhooks.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Native',
  },
  cron: {
    ...
    category: 'Automation', icon: 'cron.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Native',
  },
  pipedream: {
    ...
    category: 'Automation', icon: 'pipedream.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Pipedream',
  },
  activepieces: {
    ...
    category: 'Automation', icon: 'activepieces.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ActivePieces',
  },
  windmill: {
    ...
    category: 'Automation', icon: 'windmill.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Windmill',
  },
  temporal: {
    ...
    category: 'Automation', icon: 'temporal.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Temporal',
  },
  trigger_dev: {
    ...
    category: 'Automation', icon: 'trigger_dev.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Trigger.dev',
  },
  inngest: {
    ...
    category: 'Automation', icon: 'inngest.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Inngest',
  },
  retool_workflows: {
    ...
    category: 'Automation', icon: 'retool_workflows.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Retool',
  },
  airflow: {
    ...
    category: 'Automation', icon: 'airflow.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Apache',
  },
  prefect: {
    ...
    category: 'Automation', icon: 'prefect.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Prefect',
  },
  kestra: {
    ...
    category: 'Automation', icon: 'kestra.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Kestra',
  },
  huginn: {
    ...
    category: 'Automation', icon: 'huginn.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Open Source',
  },
};
