...
export const nativeAnalyticsIntegrations: Record<string, Integration> = {
  google_analytics: {
    ...
    category: 'Analytics', icon: 'google_analytics.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  mixpanel: {
    ...
    category: 'Analytics', icon: 'mixpanel.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Mixpanel',
  },
  amplitude: {
    ...
    category: 'Analytics', icon: 'amplitude.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Amplitude',
  },
  segment: {
    ...
    category: 'Analytics', icon: 'segment.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Twilio',
  },
  posthog: {
    ...
    category: 'Analytics', icon: 'posthog.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'PostHog',
  },
  plausible: {
    ...
    category: 'Analytics', icon: 'plausible.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Plausible',
  },
  hotjar: {
    ...
    category: 'Analytics', icon: 'hotjar.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Hotjar',
  },
  heap: {
    ...
    category: 'Analytics', icon: 'heap.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Contentsquare',
  },
  fullstory: {
    ...
    category: 'Analytics', icon: 'fullstory.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'FullStory',
  },
  looker: {
    ...
    category: 'Analytics', icon: 'looker.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  matomo: {
    ...
    category: 'Analytics', icon: 'matomo.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Matomo',
  },
  umami: {
    ...
    category: 'Analytics', icon: 'umami.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Umami',
  },
  databox: {
    ...
    category: 'Analytics', icon: 'databox.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Databox',
  },
  chartmogul: {
    ...
    category: 'Analytics', icon: 'chartmogul.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ChartMogul',
  },
  baremetrics: {
    ...
    category: 'Analytics', icon: 'baremetrics.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Baremetrics',
  },
  snowflake: {
    ...
    category: 'Analytics', icon: 'snowflake.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Snowflake',
  },
};
