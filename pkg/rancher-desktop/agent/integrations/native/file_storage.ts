...
export const nativeFileStorageIntegrations: Record<string, Integration> = {
  ...
  dropbox: {
    ...
    category: 'File Storage', icon: '📦', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Dropbox',
  },
  onedrive: {
    ...
    category: 'File Storage', icon: '☁️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Microsoft',
  },
  box: {
    ...
    category: 'File Storage', icon: '📥', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Box',
  },
  aws_s3: {
    ...
    category: 'File Storage', icon: '🪣', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Amazon',
  },
  backblaze_b2: {
    ...
    category: 'File Storage', icon: '🔥', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Backblaze',
  },
  sharepoint: {
    ...
    category: 'File Storage', icon: '📂', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Microsoft',
  },
  google_cloud_storage: {
    ...
    category: 'File Storage', icon: '☁️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  wasabi: {
    ...
    category: 'File Storage', icon: '🟢', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Wasabi',
  },
  minio: {
    ...
    category: 'File Storage', icon: '🔴', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'MinIO',
  },
  sftp: {
    ...
    category: 'File Storage', icon: '📡', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Native',
  },
  cloudinary: {
    ...
    category: 'File Storage', icon: '🌤️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Cloudinary',
  },
  uploadthing: {
    ...
    category: 'File Storage', icon: '⬆️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'UploadThing',
  },
  azure_blob: {
  ...
  r2: {
    ...
    category: 'File Storage', icon: '☁️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Cloudflare',
  },
  imgbb: {
    ...
    category: 'File Storage', icon: '🖼️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ImgBB',
  },
};
