...
export const nativeProjectManagementIntegrations: Record<string, Integration> = {
  ...
  linear: {
    ...
    category: 'Project Management', icon: 'linear.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Linear',
  },
  asana: {
  ...
  clickup: {
    ...
    category: 'Project Management', icon: 'clickup.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ClickUp',
  },
  monday: {
    ...
    category: 'Project Management', icon: 'monday.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Monday.com',
  },
  notion_projects: {
    ...
    category: 'Project Management', icon: 'notion_projects.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Notion',
  },
  wrike: {
    ...
    category: 'Project Management', icon: 'wrike.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Wrike',
  },
  shortcut: {
    ...
    category: 'Project Management', icon: 'shortcut.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Shortcut',
  },
  height: {
    ...
    category: 'Project Management', icon: 'height.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Height',
  },
  teamwork: {
    ...
    category: 'Project Management', icon: 'teamwork.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Teamwork',
  },
  pivotal_tracker: {
    ...
    category: 'Project Management', icon: 'pivotal_tracker.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'VMware',
  },
  microsoft_planner: {
    ...
    category: 'Project Management', icon: 'microsoft_planner.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Microsoft',
  },
  youtrack: {
    ...
    category: 'Project Management', icon: 'youtrack.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'JetBrains',
  },
  plane: {
    ...
    category: 'Project Management', icon: 'plane.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Plane',
  },
  taiga: {
    ...
    category: 'Project Management', icon: 'taiga.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Taiga',
  },
};
