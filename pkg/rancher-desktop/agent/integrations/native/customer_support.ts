...
export const nativeCustomerSupportIntegrations: Record<string, Integration> = {
  ...
  freshdesk: {
    ...
    category: 'Customer Support', icon: '🍃', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Freshworks',
  },
  intercom: {
    ...
    category: 'Customer Support', icon: '💬', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Intercom',
  },
  crisp: {
    ...
    category: 'Customer Support', icon: '💭', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Crisp',
  },
  help_scout: {
    ...
    category: 'Customer Support', icon: '🏠', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Help Scout',
  },
  front: {
    ...
    category: 'Customer Support', icon: '📬', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Front',
  },
  tawk_to: {
    ...
    category: 'Customer Support', icon: '💬', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Tawk.to',
  },
  hubspot_service: {
    ...
    category: 'Customer Support', icon: '🟠', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'HubSpot',
  },
  servicenow: {
    ...
    category: 'Customer Support', icon: '🟩', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ServiceNow',
  },
  kayako: {
    ...
    category: 'Customer Support', icon: '🛶', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Kayako',
  },
  zoho_desk: {
    ...
    category: 'Customer Support', icon: '🔴', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Zoho',
  },
  drift: {
    ...
    category: 'Customer Support', icon: '🤖', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Salesloft',
  },
  gladly: {
    ...
    category: 'Customer Support', icon: '😊', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Gladly',
  },
  gorgias: {
    ...
    category: 'Customer Support', icon: '🛒', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Gorgias',
  },
  liveagent: {
    ...
    category: 'Customer Support', icon: '🎧', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'QualityUnit',
  },
  typebot: {
    ...
    category: 'Customer Support', icon: '🤖', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Typebot',
  },
  chatwoot: {
    ...
    category: 'Customer Support', icon: '💬', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Chatwoot',
  },
};
