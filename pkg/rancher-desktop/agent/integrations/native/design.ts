...
export const nativeDesignIntegrations: Record<string, Integration> = {
  ...
  canva: {
    ...
    category: 'Design', icon: '🖼️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Canva',
  },
  miro: {
    ...
    category: 'Design', icon: '🟡', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Miro',
  },
  sketch: {
    ...
    category: 'Design', icon: '💎', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Sketch B.V.',
  },
  adobe_cc: {
    ...
    category: 'Design', icon: '🔴', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Adobe',
  },
  invision: {
    ...
    category: 'Design', icon: '🩷', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'InVision',
  },
  framer: {
    ...
    category: 'Design', icon: '🖥️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Framer',
  },
  zeplin: {
    ...
    category: 'Design', icon: '📐', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Zeplin',
  },
  abstract: {
    ...
    category: 'Design', icon: '🔀', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Abstract',
  },
  lottiefiles: {
    ...
    category: 'Design', icon: '🎬', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'LottieFiles',
  },
  maze: {
    ...
    category: 'Design', icon: '🧪', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Maze',
  },
  storybook: {
    ...
    category: 'Design', icon: '📖', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Open Source',
  },
  excalidraw: {
    ...
    category: 'Design', icon: '✏️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Excalidraw',
  },
  penpot: {
    ...
    category: 'Design', icon: '🎨', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Kaleidos',
  },
  whimsical: {
    ...
    category: 'Design', icon: '🌀', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Whimsical',
  },
  lucidchart: {
    ...
    category: 'Design', icon: '💡', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Lucid Software',
  },
};
