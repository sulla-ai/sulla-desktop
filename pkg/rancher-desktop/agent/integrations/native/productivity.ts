...
export const nativeProductivityIntegrations: Record<string, Integration> = {
  ...
  google_sheets: {
    ...
    category: 'Productivity', icon: 'google_sheets.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  airtable: {
    ...
    category: 'Productivity', icon: 'airtable.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Airtable',
  },
  todoist: {
    ...
    category: 'Productivity', icon: 'todoist.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Doist',
  },
  google_calendar: {
    ...
    category: 'Productivity', icon: 'google_calendar.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  google_docs: {
    ...
    category: 'Productivity', icon: 'google_docs.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  typeform: {
    ...
    category: 'Productivity', icon: 'typeform.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Typeform',
  },
  evernote: {
    ...
    category: 'Productivity', icon: 'evernote.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Evernote',
  },
  obsidian: {
    ...
    category: 'Productivity', icon: 'obsidian.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Obsidian',
  },
  coda: {
    ...
    category: 'Productivity', icon: 'coda.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Coda',
  },
  clockify: {
    ...
    category: 'Productivity', icon: 'clockify.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Clockify',
  },
  toggl: {
    ...
    category: 'Productivity', icon: 'toggl.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Toggl',
  },
  microsoft_excel: {
    ...
    category: 'Productivity', icon: 'microsoft_excel.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Microsoft',
  },
  jotform: {
    ...
    category: 'Productivity', icon: 'jotform.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'JotForm',
  },
  google_forms: {
    ...
    category: 'Productivity', icon: 'google_forms.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  basecamp: {
    ...
    category: 'Productivity', icon: 'basecamp.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: '37signals',
  },
  smartsheet: {
    ...
    category: 'Productivity', icon: 'smartsheet.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Smartsheet',
  },
  calendly: {
    ...
    category: 'Productivity', icon: 'calendly.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Calendly',
  },
};
