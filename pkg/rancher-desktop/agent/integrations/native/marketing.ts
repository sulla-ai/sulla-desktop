...
export const nativeMarketingIntegrations: Record<string, Integration> = {
  mailchimp: {
    ...
    category: 'Marketing', icon: '🐵', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Intuit',
  },
  sendgrid: {
    ...
    category: 'Marketing', icon: '📤', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Twilio',
  },
  convertkit: {
    ...
    category: 'Marketing', icon: '✉️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ConvertKit',
  },
  activecampaign: {
    ...
    category: 'Marketing', icon: '⚙️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'ActiveCampaign',
  },
  brevo: {
    ...
    category: 'Marketing', icon: '📨', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Brevo',
  },
  google_ads: {
    ...
    category: 'Marketing', icon: '📢', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Google',
  },
  meta_ads: {
    ...
    category: 'Marketing', icon: '📱', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Meta',
  },
  hubspot_marketing: {
    ...
    category: 'Marketing', icon: '🟠', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'HubSpot',
  },
  klaviyo: {
    ...
    category: 'Marketing', icon: '💚', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Klaviyo',
  },
  customer_io: {
    ...
    category: 'Marketing', icon: '📧', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Customer.io',
  },
  drip: {
    ...
    category: 'Marketing', icon: '💧', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Drip',
  },
  beehiiv: {
    ...
    category: 'Marketing', icon: '🐝', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Beehiiv',
  },
  substack: {
    ...
    category: 'Marketing', icon: '📰', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Substack',
  },
  linkedin_ads: {
    ...
    category: 'Marketing', icon: '💼', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Microsoft',
  },
  resend: {
    ...
    category: 'Marketing', icon: '✉️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Resend',
  },
  postmark: {
    ...
    category: 'Marketing', icon: '📫', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Wildbit',
  },
  mailgun: {
    ...
    category: 'Marketing', icon: '🔫', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Sinch',
  },
};
