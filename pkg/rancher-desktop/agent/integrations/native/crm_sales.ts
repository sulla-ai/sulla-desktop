...
export const nativeCrmSalesIntegrations: Record<string, Integration> = {
  ...
  salesforce: {
    ...
    category: 'CRM & Sales', icon: '☁️', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Salesforce',
  },
  pipedrive: {
    ...
    category: 'CRM & Sales', icon: '🟢', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Pipedrive',
  },
  zoho_crm: {
    ...
    category: 'CRM & Sales', icon: '🔴', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Zoho',
  },
  apollo: {
    ...
    category: 'CRM & Sales', icon: '🚀', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Apollo.io',
  },
  close: {
    ...
    category: 'CRM & Sales', icon: '📞', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Close',
  },
  freshsales: {
    ...
    category: 'CRM & Sales', icon: '🍏', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Freshworks',
  },
  copper: {
    ...
    category: 'CRM & Sales', icon: '🟤', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Copper',
  },
  attio: {
    ...
    category: 'CRM & Sales', icon: '🔷', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Attio',
  },
  outreach: {
    ...
    category: 'CRM & Sales', icon: '📤', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Outreach',
  },
  salesloft: {
    ...
    category: 'CRM & Sales', icon: '🎯', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Salesloft',
  },
  instantly: {
    ...
    category: 'CRM & Sales', icon: '⚡', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Instantly',
  },
  lemlist: {
    ...
    category: 'CRM & Sales', icon: '🍋', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Lemlist',
  },
  microsoft_dynamics: {
    ...
    category: 'CRM & Sales', icon: '🟦', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Microsoft',
  },
  sugarcrm: {
    ...
    category: 'CRM & Sales', icon: '🍬', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'SugarCRM',
  },
  clearbit: {
  ...
  hunter: {
    ...
    category: 'CRM & Sales', icon: '🎯', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Hunter',
  },
};
